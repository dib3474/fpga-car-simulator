...
HD_PWD='C:/Users/user/OneDrive/  2 2/logic_circuit/Term_project/Term_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Car_Simulator_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Car_Simulator_Top.tcl -notrace

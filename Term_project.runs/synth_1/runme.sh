...
HD_PWD='C:/Users/user/OneDrive/  2 2/logic_circuit/Term_project/Term_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Car_Simulator_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Car_Simulator_Top.tcl
